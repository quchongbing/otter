...
def write_citations_markdown(path: str | Path = "CITATIONS.md") -> Path:
    ...
    lines = [
        ...
        "## For users",
        "",
        "Cite Otter using `CITATION.cff`, then cite the physical/model papers",
        "for the options used in a calculation. Configuration objects expose:",
        "",
        "```python",
        ...
        "",
        "## For contributors and vibecoding",
        "",
