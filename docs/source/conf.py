...
project = "otter"
copyright = "2026 Chongbing Qu, and contributors"
author = "Chongbing Qu, and contributors"
...
github_username = "quchongbing"
github_repository = "otter"
...
bibtex_bibfiles = [
    str(pathlib.Path(otter.__file__).parent / "literature.bib")
]
